...
ENABLE_OPERATIONAL_PRICE_MONITORING = _bool_env("ENABLE_OPERATIONAL_PRICE_MONITORING", False)
...
OPERATIONAL_PRICE_MAX_LISTINGS_PER_JOB = int(os.getenv("OPERATIONAL_PRICE_MAX_LISTINGS_PER_JOB", str(PRICE_REFRESH_BATCH_SIZE)))
OPERATIONAL_PRICE_MAX_WINDOWS_PER_JOB = int(os.getenv("OPERATIONAL_PRICE_MAX_WINDOWS_PER_JOB", "3"))
OPERATIONAL_PRICE_MAX_NO_PROGRESS_WINDOWS = int(os.getenv("OPERATIONAL_PRICE_MAX_NO_PROGRESS_WINDOWS", "2"))
OPERATIONAL_PRICE_NO_PROGRESS_RETRY_SECONDS = int(os.getenv("OPERATIONAL_PRICE_NO_PROGRESS_RETRY_SECONDS", "3600"))
...
FULL_SWEEP_UNTRUSTED_RETRY_DELAY_SECONDS = int(os.getenv("FULL_SWEEP_UNTRUSTED_RETRY_DELAY_SECONDS", "21600"))
PROCESS_NEW_LISTING_BATCH_SIZE = int(os.getenv("PROCESS_NEW_LISTING_BATCH_SIZE", "2"))
...
NETWORK_DEBUG = _bool_env("NETWORK_DEBUG", False)
...
JOB_STALE_TIMEOUT_MINUTES_PROCESS_NEW_LISTING = int(os.getenv("JOB_STALE_TIMEOUT_MINUTES_PROCESS_NEW_LISTING", "30"))
...
JOB_STALE_TIMEOUT_MINUTES_SETUP_DETAIL_BASELINE = int(os.getenv("JOB_STALE_TIMEOUT_MINUTES_SETUP_DETAIL_BASELINE", "120"))
JOB_STALE_TIMEOUT_MINUTES_SETUP_PRICE_BASELINE = int(os.getenv("JOB_STALE_TIMEOUT_MINUTES_SETUP_PRICE_BASELINE", "300"))
...
NOTIFICATION_STALE_SENDING_MINUTES = int(os.getenv("NOTIFICATION_STALE_SENDING_MINUTES", "30"))
NOTIFICATION_MAX_ATTEMPTS = int(os.getenv("NOTIFICATION_MAX_ATTEMPTS", "5"))
NOTIFICATION_RETRY_BACKOFF_SECONDS = int(os.getenv("NOTIFICATION_RETRY_BACKOFF_SECONDS", "300"))
_BASELINE_DETAIL_BATCH_ENV = os.getenv("BASELINE_DETAIL_BATCH_SIZE")
_SETUP_DETAIL_BATCH_ENV = os.getenv("SETUP_DETAIL_BATCH_SIZE")
if _BASELINE_DETAIL_BATCH_ENV and _SETUP_DETAIL_BATCH_ENV and int(_BASELINE_DETAIL_BATCH_ENV) != int(_SETUP_DETAIL_BATCH_ENV):
    raise ValueError(
        "BASELINE_DETAIL_BATCH_SIZE and deprecated SETUP_DETAIL_BATCH_SIZE differ; "
        "set only BASELINE_DETAIL_BATCH_SIZE=75 or make both values equal."
    )
BASELINE_DETAIL_BATCH_SIZE = int(_BASELINE_DETAIL_BATCH_ENV or _SETUP_DETAIL_BATCH_ENV or "75")
SETUP_DETAIL_BATCH_SIZE = BASELINE_DETAIL_BATCH_SIZE
BASELINE_LARGE_AREA_THRESHOLD = int(os.getenv("BASELINE_LARGE_AREA_THRESHOLD", "100"))
BASELINE_MAX_ACTIVE_SETUP_JOBS_PER_AREA = int(os.getenv("BASELINE_MAX_ACTIVE_SETUP_JOBS_PER_AREA", "1"))
BASELINE_PROGRESS_LOG_INTERVAL = int(os.getenv("BASELINE_PROGRESS_LOG_INTERVAL", "10"))
