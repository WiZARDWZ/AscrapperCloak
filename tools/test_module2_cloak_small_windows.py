...
def build_summary(*, csv_path=None, json_path=None, logs: list[str], crash: bool = False, error: str | None = None) -> dict:
    ...
    return {
        ...
        "window_page_stats": last_result.get("window_page_stats", []),
        "pagination_nav_mode": last_result.get("pagination_nav_mode"),
        "window_nav_mode": last_result.get("window_nav_mode"),
        "fallback_paths": last_result.get("fallback_paths", []),
        "window_fallback_paths": last_result.get("window_fallback_paths", []),
        "ended_window_reasons": last_result.get("ended_window_reasons", []),
        "recovery_attempts": last_result.get("recovery_attempts", []),
